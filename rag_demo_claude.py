...
claude_api_key = "Input your key here"
...
# load the model
Settings.llm = Anthropic(model="claude-3-5-sonnet-20240620", api_key=claude_api_key)
Settings.embed_model = GeminiEmbedding(api_key=gemini_pro_api_key, model="models/embedding-001")  # Use the appropriate embedding model name for Gemini-pro
